...
Target:
1) IEL Index (II) - Nr IELs per unit dysplasia area (in microns)
2) IEL Count (IC) - Nr IELs per 100 epithelial cells
3) IEL Peak Index (IPI) - Nr IELs per unit dysplasia area (in microns) in most dense field of view
4) IEL Peak Count (IPC) - Nr IELs per 100 epithelial cells in most dense field of view
